	...
	<body>
		...
		<div class="main">
			...
			<article>
				...
				<!-- display the records -->	
				<h3 style="margin-bottom: 30px">You selected flight schedule <%=flightschedule_id%> to update.</h3>
			...
			<%}%>
				...
				<!-- the update form -->
				<form class="form-horizontal" action="flightschedulebackend.jsp?task=individualupdate" method="POST">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<input type="submit" class="btn btn-warning" value="Update Flight Schedule">
