...
@WebServlet("/ObtainPromotionServlet")
public class ObtainPromotionServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ObtainPromotionServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			session.setAttribute("promotiondispatch", "YES");
